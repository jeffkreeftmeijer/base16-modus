...
A [[https://github.com/chriskempson/base16][base16]] representation of prot's [[https://protesilaos.com/emacs/modus-themes][Modus themes]] (and the derivative [[https://protesilaos.com/emacs/standard-themes][Standard themes]] and [[https://protesilaos.com/emacs/ef-themes][Ef themes]] ), extracted from Emacs to use with [[https://github.com/nix-community/stylix][Stylix]] in my Nix-based configuration.
...
It is not meant as a replacement for the Modus themes, or a reason not to port them to other apps manually.
It is, given there are no handcrafted ports of the Modus themes, the best we can currently do.

* Generate base16 YAML representations of the modus themes
:PROPERTIES:
:CUSTOM_ID: base16-modus-generate
:END:

The ~base16-themes-generate~ function loops over each theme in ~standard-themes-collection~, ~modus-themes-collection~, and ~ef-themes-collection~.
